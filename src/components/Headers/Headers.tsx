        ...
        <div className='grid grid-cols-12 gap-4 mt-4 items-end'>
          ...
          <form className='col-span-9' onSubmit={onSubmitSearch}>
            <div className='bg-white  rounded-sm p-1 flex'>
              <input type='text' className='text-black px-3 py-2 flex-grow border-none outline-none bg-transparent' {...register('name')} />
                    ...
                    {purchasesInCart.slice(0, MAX_PURCHASES).map((purchase) => (
                      <div className="mt-2 py-2 flex hover:bg-gray-100" key={purchase._id}>
                        <div className="flex-shrink-0 w-11 h-11">
                          <img src={purchase.product.image} alt={purchase.product.image} />
                        </div>
